...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 bg-gray-900 text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Next Step Workforce Solutions</h2>
            <p className="text-sm">© 2025 Next Step Workforce Solutions. All rights reserved.</p>
          </div>
